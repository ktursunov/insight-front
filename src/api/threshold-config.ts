...
export const BULLET_DEFS: BulletThresholdDef[] = [
  ...
  { metric_key: 'cc_cost',           section: 'ai_adoption',   label: 'Claude Code Cost',                         sublabel: 'Claude Team plan \u00b7 per-user cost \u00b7 period total',              unit: '\u00a2', drill_id: '',             higher_is_better: false, good: 5000, warn: 10000 },
  { metric_key: 'prs_with_cc',       section: 'ai_adoption',   label: 'PRs with Claude Code',                     sublabel: 'Anthropic GitHub-app \u00b7 PRs with CC activity \u00b7 period total',   unit: 'PRs',  drill_id: '',             higher_is_better: true,  good: 3,   warn: 1   },
  { metric_key: 'prs_total',         section: 'ai_adoption',   label: 'Total PRs (CC window)',                    sublabel: 'Anthropic GitHub-app \u00b7 total PRs in measurement window',            unit: 'PRs',  drill_id: '',             higher_is_better: true,  good: 5,   warn: 2   },
