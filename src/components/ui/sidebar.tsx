      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{t("common.ui_components.sidebar.title")}</SheetTitle>
            <SheetDescription>
              {t("common.ui_components.sidebar.description")}
            </SheetDescription>
          </SheetHeader>
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">
        {t("common.ui_components.sidebar.toggle")}
      </span>
    </Button>
  );
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={t("common.ui_components.sidebar.toggle")}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={t("common.ui_components.sidebar.toggle")}
      className={cn(
